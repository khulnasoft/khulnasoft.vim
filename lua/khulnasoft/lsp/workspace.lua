...
-- Lua module: khulnasoft.lsp.workspace
local M = {}
...
function M.new()
  ...
  return {
    ...
    change_configuration = function(self, cfg)
      ...
      notifier.notify('khulnasoft.vim: Workspace configuration changed', vim.log.levels.WARN)
    end,
    subscribe_client = function(client_id)
      notifier.notify(
        'khulnasoft.vim: Subscribing client ' .. tostring(client_id),
