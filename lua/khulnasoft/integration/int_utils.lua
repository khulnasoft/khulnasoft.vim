...
local system = vim.system or require("khulnasoft.system")
...
local khulnasoft = load("lua/khulnasoft/integration/khulnasoft")
local khulnasoft_partial = load("lua/khulnasoft/integration/khulnasoft.partial")
local empty = load("lua/khulnasoft/integration/empty")
...
return {
    ...
    khulnasoft_partial = khulnasoft_partial,
    empty = empty,
