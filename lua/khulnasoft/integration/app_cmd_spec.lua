...
local int_utils = require("khulnasoft.integration.int_utils")
local utils = require("khulnasoft.tcp.utils")
local optsify = require("khulnasoft.utils").optsify
local App = require("khulnasoft.app")
...
describe("vim with me :: app_spec", function()
    ...
    it("app integration test", function()
        ...
        eq(int_utils.khulnasoft, table.concat(app.cache:to_string_rows()))
