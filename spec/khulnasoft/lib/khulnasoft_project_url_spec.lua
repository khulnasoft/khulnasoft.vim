local khulnasoft_project_url = require('khulnasoft.lib.khulnasoft_project_url')
...
describe('khulnasoft_project_url', function()
  describe('Local paths', function()
    ...
    for _, path in ipairs(paths) do
      describe(path, function()
        local actual = khulnasoft_project_url.parse(path)
  ...
  describe('Protocols', function()
    local tests = {
      ...
      {
        input = 'https://github.com/khulnasoft/khulnasoft.vim.git',
        full_path = 'khulnasoft/khulnasoft.vim',
      },
      { input = 'https://github.com/khulnasoft/khulnasoft.git', full_path = 'khulnasoft/khulnasoft' },
    ...
    for _, test in ipairs(tests) do
      it(test.input, function()
        local actual = khulnasoft_project_url.parse(test.input)
  ...
  describe('Schemeless protocols', function()
    local tests = {
      {
        input = 'git@github.com:khulnasoft/khulnasoft.vim.git',
        full_path = 'khulnasoft/khulnasoft.vim',
      },
